...
import { getPopularMovies, getPopularTVShows, getTopRatedMovies, getTopRatedTVShows, getTrendingAll, getPosterUrl, Movie, TVShow } from '@/lib/tmdb'
...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-16 mb-12">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            <h1 className="text-5xl md:text-6xl font-bold mb-4 bg-gradient-to-r from-primary-400 via-primary-500 to-primary-600 bg-clip-text text-transparent">
              Hoş Geldiniz.
            </h1>
      ...
      <div className="container mx-auto px-4 pb-12">
        ...
        {popularMovies.results.length > 0 && (
          <section className="mb-12 bg-gradient-to-br from-blue-600 via-cyan-600 to-teal-600 rounded-2xl p-8 shadow-xl">
        ...
        {popularTVShows.results.length > 0 && (
          <section className="mb-12 bg-gradient-to-br from-emerald-600 via-green-600 to-lime-600 rounded-2xl p-8 shadow-xl">
            <div className="flex items-center justify-between mb-6">
